...
export function getComponents() {
    for (const type of Object.keys(components)) {
        ...
        CompClass.prototype.render = (function () {
            ...
            const componentRef = viewContainer.createComponent(CompClass.MaterialComponent);
...
export function registerComponent(name: string, CompClass: any) {
    ...
    formIOComp.prototype.render = (function () {
        ...
        const componentRef = viewContainer.createComponent(formIOComp.MaterialComponent);
        this.materialComponent = componentRef.instance;
        this.disabled = this.shouldDisabled;
        (componentRef.instance as any).setInstance(this);
        (componentRef.instance as any).setVisible(this.visible);
    });
