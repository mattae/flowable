...
// 自定义的属性
// 办理人
var assigneeListProps = require('./parts/AssigneeListProps');

// 是否是必经节点
var isMajorProps = require('./parts/IsMajorProps');

// 截止时间
var deadlineProps = require('./parts/DeadlineProps');
// 时分
var timeDivisionProps = require('./parts/TimeDivisionProps');
...
function createGeneralTabGroups(
   ...
   // executableProps(generalGroup, element, translate);
    ...
    // 受理人
    assigneeListProps(generalGroup, element, bpmnFactory, translate);
   ...
   // linkProps(detailsGroup, element, translate);
    ...
    var timeGroup = {
        id: 'timeGroup',
        label: translate('时间相关组件'),
        entries: []
    };

    deadlineProps(timeGroup, element, elementRegistry, bpmnFactory, translate);
    timeDivisionProps(timeGroup, element, elementRegistry, bpmnFactory, translate);
...
function FlowablePropertiesProvider(
    eventBus, canvas, bpmnFactory, propertiesPanel,
    elementRegistry, elementTemplates, translate) {
