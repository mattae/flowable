...
var FLOWABLE_FIELD_EXTENSION_ELEMENT = 'flowable:Field';
...
module.exports = function(element, bpmnFactory, translate, options) {
  ...
  function getFlowableFields(element, node) {
    if (!insideListener) {
      return (
        businessObject &&
        extensionElementsHelper.getExtensionElements(businessObject, FLOWABLE_FIELD_EXTENSION_ELEMENT)
      ) || [];
    }
  ...
  var newElement = function() {
    return function(element, extensionElements, value, node) {
      ...
      if (!insideListener) {
        ...
        newFieldElem = elementHelper.createElement(FLOWABLE_FIELD_EXTENSION_ELEMENT, props, extensionElements, bpmnFactory);
        return cmdHelper.addElementsTolist(element, extensionElements, 'values', [ newFieldElem ]);

      } else {

        var selectedListener = getSelectedListener(element, node);
        newFieldElem = elementHelper.createElement(FLOWABLE_FIELD_EXTENSION_ELEMENT, props, selectedListener, bpmnFactory);
