...
public class FlowableProcessInstanceQueryService {
    ...
    public FlowableProcessInstanceQueryService(RepositoryService repositoryService, AppRepositoryService appRepositoryService, HistoryService historyService, UserCache userCache) {
    ...
    public ResultListDataRepresentation getProcessInstances(ObjectNode requestNode) {
        ...
        if (page != 0 || instances.size() == size) {
            ...
            result.setTotal((long) (int) totalCount);
