...
public class GetVariablesFromFormSubmissionCmd implements Command<Map<String, Object>>, Serializable {
    ...
    protected Object transformFormFieldValueToVariableValue(FormField field, Object formFieldValue) {
        FormIOFormModel.Component formField = (FormIOFormModel.Component) field;
        Object result = formFieldValue;
        if (formField.getType().equals(FieldTypes.datetime.name()) && formFieldValue instanceof String) {
        ...
        } else if (formField.getType().equals(FieldTypes.datetime.name()) && formFieldValue instanceof Date) {
            result = new LocalDate(formFieldValue);
        } else if (formField.getType().equals(FieldTypes.number.name()) && formFieldValue instanceof String) {
